 ...
 */
public class MCEngineArtificialIntelligenceApiDBMySQL implements IMCEngineArtificialIntelligenceApiDatabase {
     ...
     */
    public MCEngineArtificialIntelligenceApiDBMySQL(Plugin plugin) {
        this.plugin = plugin;
